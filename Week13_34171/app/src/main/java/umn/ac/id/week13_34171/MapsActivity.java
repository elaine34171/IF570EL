package umn.ac.id.week13_34171;
...
import umn.ac.id.week13_34171.databinding.ActivityMapsBinding;

public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    private UiSettings mUiSettings;
    private GoogleMap mMap;
    static LatLng currentLocation; private List<MarkerDanShape> daftarMarkerDanShape = new ArrayList<MarkerDanShape>();
    ...
    protected void gambarMarkerDanShape() {
        for(int i = 0 ; i < daftarMarkerDanShape.size(); i++) {
            ...
            if(ms.getJenis().equalsIgnoreCase("Marker")) {
                ...
                if (ms.getJenis().equalsIgnoreCase("Circle")) {
                    ...
                    if(ms.getJenis().equalsIgnoreCase("PolyLine")) {
                        ...
                        if(ms.getJenis().equalsIgnoreCase("Polygon")) {
